...
const beachImage = "/images/fuengirola-beach.webp";
// TODO: Add verified local photos for Santa Amalia and Playa del Castillo before expanding the visible gallery to 3-6 images.
...
export const beachGuideContent: Record<Locale, BeachGuideContent> = {
  es: {
    ...
    galleryIntro: "Actualmente usamos una imagen local real de Fuengirola. Añadiremos más fotografías propias de Santa Amalia y Playa del Castillo cuando estén disponibles.",
    gallery: [{ src: beachImage, alt: "Playa de Fuengirola y paseo marítimo cerca del apartamento" }],
  ...
  en: {
    ...
    galleryIntro: "We currently use a real local image from Fuengirola. More own photos of Santa Amalia and Castle Beach will be added when available.",
    gallery: [{ src: beachImage, alt: "Fuengirola Beach and promenade near the apartment" }],
    ...
    beaches: [
      { key: "fuengirola", name: "Fuengirolan ranta", badge: "Pääranta · Rantakatu", walkingTime: "≈ 8 min kävellen", image: beachImage, imageAlt: "Fuengirolan ranta rantakadun vieressä", description: "Fuengirolan ranta on helpoin valinta arkeen. Leveä hiekkaranta, yleensä rauhallinen vesi, rantakatu sekä monet chiringuitot ja ravintolat tekevät siitä käytännöllisen etenkin perheille.", services: ["Suihkut ja jalkasuihkut", "Julkiset wc:t", "Chiringuitot", "Leikkialue", "Liikuntavarusteita", "Helppo pääsy kävellen"], idealFor: ["Perheet", "Kävely", "Aurinkotuolit", "Ravintolat", "Rauhallinen uinti"], tip: "Saavu ennen klo 10.00, niin tilaa löytyy yleensä paremmin myös kesällä." },
      { key: "santaAmalia", name: "Santa Amalian ranta", badge: "Perheystävällinen · Lähellä", walkingTime: "≈ 12 min kävellen", image: beachImage, imageAlt: "Ranta- ja rantakatualue Fuengirolassa", description: "Santa Amalia on kaupunkimainen ja perheystävällinen ranta, joka liittyy suoraan rantakatuun. Se sopii muutaman tunnin rentoon rantapäivään, kävelyyn tai chiringuito-pysähdykseen.", services: ["Suihkut", "Wc:t", "Chiringuitot ja ravintolat", "Leikkialue", "Aurinkotuoleja kaudella", "Vesiaktiviteetteja kaudella"], idealFor: ["Perheet", "Rantakatu", "Rauhallisempi alue", "Chiringuitot", "Helppo uinti"], tip: "Hyvä valinta, kun haluat rannan läheltä ilman että poistut kauas kaupoista, ravintoloista ja rantakadulta." },
      { key: "castle", name: "Castillo-ranta", badge: "Laaja ranta · Sohailin linna", walkingTime: "≈ 18 min kävellen", image: beachImage, imageAlt: "Laaja välimerellinen ranta Fuengirolassa", description: "Castillo-ranta on leveämpi ja avoimempi ranta Sohailin linnan vieressä. Se sopii kävelyyn, auringonlaskuihin ja väljempään rantatunnelmaan. Alueella on myös rajattu koiraranta ja liikuntapaikkoja.", services: ["Suihkut ja wc:t", "Rajattu koira-alue", "Liikunta-alueita", "Leikkialue", "Chiringuitot", "Pääsy kävellen tai autolla"], idealFor: ["Auringonlaskut", "Kävely", "Koirat", "Vesiurheilu", "Väljyys"], tip: "Yhdistä ranta kävelyyn Sohailin linnalle tai jokipuistoon rauhallista iltaa varten." }
    ],
    featureCards: [
    ...
    galleryTitle: "Galleria", galleryIntro: "Käytämme tällä hetkellä yhtä oikeaa paikallista kuvaa Fuengirolasta. Lisää omia kuvia Santa Amaliasta ja Castillo-rannasta lisätään myöhemmin.", gallery: [{ src: beachImage, alt: "Fuengirolan ranta ja rantakatu lähellä asuntoa" }],
  ...
  sv: {
    ...
    galleryTitle: "Galleri", galleryIntro: "Just nu använder vi en riktig lokal bild från Fuengirola. Fler egna bilder från Santa Amalia och Castillo läggs till när de finns.", gallery: [{ src: beachImage, alt: "Fuengirola strand och strandpromenad nära lägenheten" }],
  ...
  no: {
    ...
    galleryTitle: "Galleri", galleryIntro: "Foreløpig bruker vi ett ekte lokalt bilde fra Fuengirola. Flere egne bilder av Santa Amalia og Castillo legges til når de finnes.", gallery: [{ src: beachImage, alt: "Fuengirola-stranden og strandpromenaden nær leiligheten" }],
