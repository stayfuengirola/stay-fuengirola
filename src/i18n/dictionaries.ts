...
const en: Dictionary = {
  ...
  area: {
    title: "Fuengirola and nearby places",
    beachesTitle: "Beaches",
    beachesText: "Fuengirola Beach is about 600 m away, with long promenades and easy Mediterranean days.",
    restaurantsTitle: "Restaurants",
    restaurantsText: "Restaurants, cafes and supermarkets are a few minutes away on foot.",
    mijasTitle: "Mijas Pueblo",
    mijasText: "A classic white village about 9 km away, ideal for a half-day trip.",
    malagaTitle: "Malaga and excursions",
    malagaText: "Malaga, Marbella, coastal towns and Costa del Sol day trips are easy to combine with your stay."
  },
  nordic: {
  ...
  rules: {
    ...
    checkin: "Check-in: from 15:00 to 18:00. Guests must communicate their approximate arrival time in advance.",
    checkout: "Check-out: from 10:00 to 11:00.",
  ...
  faq: {
    ...
    checkinA: "From 15:00 to 18:00. You need to communicate your approximate arrival time in advance.",
    checkoutQ: "What time should I leave the apartment?",
    checkoutA: "Between 10:00 and 11:00.",
...
const es: Dictionary = {
  ...
  location: { ...en.location, title: "Tu base ideal para explorar la Costa del Sol", text: "Desde aquí podrás llegar caminando a la playa, restaurantes, supermercados y al Centro Comercial Miramar. Además, Marbella, Málaga y algunos de los lugares más conocidos de la Costa del Sol están a poca distancia.", zoneLabel: "Zona", fuengirolaBeach: "Playa de Fuengirola", castleBeach: "Playa de El Castillo", miramar: "Centro Comercial Miramar", sohail: "Castillo Sohail", station: "Estación de tren de Fuengirola", boliches: "Los Boliches", mijas: "Mijas Pueblo", marbella: "Marbella, aprox.", malagaCenter: "Málaga Centro, aprox.", airport: "Aeropuerto de Málaga, aprox.", map: "Mapa aproximado de la zona", openMap: "Abrir en OpenStreetMap", airportTitle: "Cómo llegar desde el aeropuerto de Málaga", airportText: "El Aeropuerto de Málaga se encuentra aproximadamente a 25 kilómetros, según la ruta. Se puede llegar en coche, taxi o transporte público, combinando el tren de cercanías con un pequeño desplazamiento hasta el apartamento.", carTitle: "En coche", carText: "20-25 minutos aproximadamente, según el tráfico.", trainTitle: "En tren", trainText: "Línea C1 hasta Fuengirola y breve trayecto hasta el apartamento.", airportCardTitle: "Desde el aeropuerto", airportCardText: "Conexión sencilla mediante coche, taxi o transporte público." },
  area: { title: "Fuengirola y alrededores", beachesTitle: "Playas", beachesText: "La Playa de Fuengirola está a unos 600 m, con paseo marítimo y días sencillos junto al Mediterráneo.", restaurantsTitle: "Restaurantes", restaurantsText: "Restaurantes, cafeterías y supermercados a pocos minutos a pie.", mijasTitle: "Mijas Pueblo", mijasText: "Un pueblo blanco clásico a unos 9 km, perfecto para una escapada de medio día.", malagaTitle: "Málaga y excursiones", malagaText: "Málaga, Marbella, pueblos costeros y excursiones por la Costa del Sol combinan fácilmente con la estancia." },
...
const fi: Dictionary = {
  ...
  location: { ...en.location, title: "Hyvä tukikohta Costa del Solin tutkimiseen", text: "Täältä pääset kävellen rannalle, ravintoloihin, supermarketteihin ja Miramar-ostoskeskukseen. Myös Marbella, Málaga ja monet Costa del Solin tunnetut kohteet ovat helposti saavutettavissa.", zoneLabel: "Alue", fuengirolaBeach: "Fuengirolan ranta", castleBeach: "El Castillon ranta", miramar: "Miramar-ostoskeskus", sohail: "Sohailin linna", station: "Fuengirolan rautatieasema", boliches: "Los Boliches", mijas: "Mijas Pueblo", marbella: "Marbella, noin", malagaCenter: "Málagan keskusta, noin", airport: "Malagan lentoasema, noin", map: "Suuntaa antava kartta-alue", openMap: "Avaa OpenStreetMapissa", airportTitle: "Saapuminen Malagan lentoasemalta", airportText: "Malagan lentoasema on noin 25 km päässä reitistä riippuen. Perille pääsee autolla, taksilla tai julkisilla kulkuvälineillä yhdistämällä lähijunan ja lyhyen siirtymän asunnolle.", carTitle: "Autolla", carText: "Noin 20-25 minuuttia liikenteestä riippuen.", trainTitle: "Junalla", trainText: "C1-linja Fuengirolaan ja lyhyt siirtymä asunnolle.", airportCardTitle: "Lentoasemalta", airportCardText: "Helppo yhteys autolla, taksilla tai julkisilla kulkuvälineillä." },
  area: { title: "Fuengirola ja lähialueet", beachesTitle: "Rannat", beachesText: "Fuengirolan ranta on noin 600 m päässä, ja rantakatu sopii helppoihin Välimeren päiviin.", restaurantsTitle: "Ravintolat", restaurantsText: "Ravintolat, kahvilat ja supermarketit ovat muutaman minuutin kävelymatkan päässä.", mijasTitle: "Mijas Pueblo", mijasText: "Perinteinen valkoinen kylä noin 9 km päässä, hyvä puolen päivän retkelle.", malagaTitle: "Malaga ja retket", malagaText: "Malaga, Marbella, rannikkokaupungit ja Costa del Solin päiväretket sopivat hyvin oleskeluun." },
...
const no: Dictionary = {
  ...
  location: { ...en.location, title: "En ideell base for å utforske Costa del Sol", text: "Herfra kan du gå til stranden, restauranter, supermarkeder og Miramar kjøpesenter. Marbella, Málaga og flere av Costa del Sols mest kjente steder er også lett tilgjengelige.", zoneLabel: "Område", fuengirolaBeach: "Fuengirola-stranden", castleBeach: "El Castillo-stranden", miramar: "Miramar kjøpesenter", sohail: "Sohail-slottet", station: "Fuengirola togstasjon", boliches: "Los Boliches", mijas: "Mijas Pueblo", marbella: "Marbella, ca.", malagaCenter: "Málaga sentrum, ca.", airport: "Malaga flyplass, ca.", map: "Omtrentlig kartområde", openMap: "Åpne i OpenStreetMap", airportTitle: "Ankomst fra Malaga flyplass", airportText: "Malaga flyplass ligger omtrent 25 km unna, avhengig av rute. Du kan komme med bil, taxi eller kollektivtransport.", carTitle: "Med bil", carText: "Omtrent 20-25 minutter, avhengig av trafikk.", trainTitle: "Med tog", trainText: "C1-linjen til Fuengirola og en kort tur videre til leiligheten.", airportCardTitle: "Fra flyplassen", airportCardText: "Enkel forbindelse med bil, taxi eller offentlig transport." },
