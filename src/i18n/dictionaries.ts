...
const en: Dictionary = {
  ...
  gallery: {
    ...
    bathroom: "Bathroom reference image",
    panoramic: "Panoramic living and dining area",
    sofa: "Comfortable sofa and lounge area",
    dining: "Dining area by the window",
    garden: "Communal garden area",
    pool: "Communal pool area",
  ...
  location: {
    ...
    exactAfterBooking: "The exact location is provided after the booking is confirmed.",
  ...
  nordic: {
    ...
    benefitSun: "More than 300 days of sunshine",
    benefitWinter: "Mild winter",
    benefitBeach: "Beach life all year round",
    benefitWalk: "Everything a few minutes on foot",
    benefitAirport: "Malaga Airport around 25 minutes away"
  },
  explore: {
  ...
  host: {
    ...
    benefitCare: "Support before and during your stay",
    benefitWhatsapp: "Fast replies on WhatsApp",
    benefitTips: "Fuengirola recommendations"
  },
  rules: {
  ...
  guide: {
    ...
    thingsToDo: "Things to do in Fuengirola",
    ...
    restaurantsText: "Two local classics for fried fish and grilled meat near the apartment.",
    shoppingText: "Centro Comercial Miramar, Parque Comercial, and Fuengirola's town center.",
    transportText: "Train, taxi and ways to move around the Costa del Sol.",
    excursionsText: "Day trips from Fuengirola: Mijas, Malaga, Ronda, Nerja, Granada and more.",
    thingsToDoText: "Bioparc, water parks, and the Marenostrum concerts.",
    bioparcText: "A practical family guide to visiting Bioparc Fuengirola from the apartment.",
...
const es: Dictionary = {
  ...
  gallery: { ...en.gallery, title: "Un primer vistazo al apartamento y su entorno", intro: "Se mantienen fotografías actuales de referencia hasta recibir las imágenes originales del alojamiento.", living: "Comedor luminoso junto a la ventana", bedroom: "Zona de descanso de referencia", kitchen: "Cocina equipada de referencia", bathroom: "Baño del apartamento", panoramic: "Vista panorámica del salón y comedor", sofa: "Sofá y zona de estar", dining: "Comedor junto a la ventana", garden: "Jardín comunitario", pool: "Zona de piscina comunitaria", terrace: "Comedor luminoso con luz natural", beach: "Paseo marítimo de Fuengirola de referencia", mijas: "Calle blanca de Mijas Pueblo de referencia" },
  ...
  guide: { ...en.guide, metaTitle: "Guía de Fuengirola | Stay Fuengirola", metaDescription: "Guía práctica de Fuengirola para huéspedes: aeropuerto, playas, supermercados, restaurantes, compras, transporte, excursiones y planes de lluvia.", title: "Guía de Fuengirola", intro: "Una guía práctica para preparar tu estancia en Fuengirola, con información local lista para ampliarse poco a poco.", comingSoon: "Próximamente", readGuide: "Ver guía", back: "Volver a la guía", airport: "Cómo llegar desde el aeropuerto", beaches: "Playas", supermarkets: "Supermercados", restaurants: "Restaurantes", shopping: "Compras", transport: "Transporte", excursions: "Excursiones", thingsToDo: "Qué hacer en Fuengirola", bioparc: "Bioparc Fuengirola", rain: "Qué hacer cuando llueve", airportText: "Conexiones desde el Aeropuerto de Málaga hasta Fuengirola.", beachesText: "Playas y paseos junto al mar cerca del apartamento.", supermarketsText: "Supermercados cercanos y compras prácticas.", restaurantsText: "Dos clásicos locales de pescaíto frito y carne a la brasa cerca del apartamento.", shoppingText: "Centro Comercial Miramar, Parque Comercial y el centro de Fuengirola.", transportText: "Tren, taxi y formas de moverse por la Costa del Sol.", excursionsText: "Mijas, Málaga, Ronda, Nerja, Granada y otras excursiones desde Fuengirola.", thingsToDoText: "Bioparc, parques acuáticos y los conciertos de Marenostrum.", bioparcText: "Guía familiar y práctica para visitar Bioparc Fuengirola desde el apartamento.", rainText: "Ideas para días tranquilos o con lluvia." }
};
...
const fi: Dictionary = {
  ...
  gallery: { ...en.gallery, title: "Ensimmäinen katsaus asuntoon ja ympäristöön", intro: "Nykyiset viitekuvat voidaan myöhemmin korvata asunnon alkuperäisillä kuvilla.", living: "Valoisa ruokailutila ikkunan äärellä", bedroom: "Makuutila, viitekuva", kitchen: "Varusteltu keittiö, viitekuva", bathroom: "Asunnon kylpyhuone", panoramic: "Panoraamanäkymä oleskelu- ja ruokailutilaan", sofa: "Sohva ja oleskelualue", dining: "Ruokailutila ikkunan äärellä", garden: "Yhteinen puutarha-alue", pool: "Yhteinen allasalue", terrace: "Valoisa ruokailutila luonnonvalossa", beach: "Fuengirolan rantakatu, viitekuva", mijas: "Mijas Pueblon valkoinen katu, viitekuva" },
  ...
  guide: { ...en.guide, metaTitle: "Fuengirola-opas | Stay Fuengirola", title: "Fuengirola-opas", intro: "Käytännön opas Fuengirolassa oleskelun suunnitteluun. Sisältöä täydennetään vähitellen.", comingSoon: "Tulossa pian", readGuide: "Lue opas", back: "Takaisin oppaaseen", airport: "Saapuminen lentoasemalta", beaches: "Rannat", supermarkets: "Supermarketit", restaurants: "Ravintolat", shopping: "Ostokset", transport: "Liikkuminen", excursions: "Retket", thingsToDo: "Mitä tehdä Fuengirolassa", bioparc: "Bioparc Fuengirola", rain: "Mitä tehdä sateella", restaurantsText: "Kaksi paikallista klassikkoa: paistettua kalaa ja grillattua lihaa lähellä asuntoa.", shoppingText: "Centro Comercial Miramar, Parque Comercial ja Fuengirolan keskusta.", excursionsText: "Päiväretkiä Fuengirolasta: Mijas, Malaga, Ronda, Nerja, Granada ja paljon muuta.", thingsToDoText: "Bioparc, vesipuistot ja Marenostrumin konsertit.", bioparcText: "Käytännön perheopas Bioparc Fuengirolaan asunnolta käsin." }
};
...
const sv: Dictionary = {
  ...
  gallery: { ...en.gallery, title: "En första titt på lägenheten och området", intro: "Nuvarande referensbilder kan senare ersättas med originalbilder från boendet.", living: "Ljus matplats vid fönstret", bedroom: "Sovdel", kitchen: "Utrustat kök", bathroom: "Badrum i lägenheten", panoramic: "Panoramavy över vardagsrum och matplats", sofa: "Soffa och sällskapsdel", dining: "Matplats vid fönstret", garden: "Gemensam trädgård", pool: "Gemensamt poolområde", terrace: "Ljus matplats med naturligt ljus", beach: "Fuengirolas strandpromenad", mijas: "Vit gata i Mijas Pueblo" },
  ...
  nordic: { title: "Därför trivs nordiska gäster i Fuengirola", text: "Fuengirola har en etablerad internationell gemenskap och är särskilt känd för sin stora finska närvaro. För många besökare från Finland, Sverige och Norge gör det längre vintervistelser både enkla och bekväma.", text2: "Internationella butiker, restauranger, kosmopolitisk atmosfär och service som är öppen året runt gör staden praktisk även utanför sommaren.", benefitSun: "Över 300 soldagar", benefitWinter: "Mild vinter", benefitBeach: "Strand året runt", benefitWalk: "Allt några minuter till fots", benefitAirport: "Malagas flygplats cirka 25 minuter bort" },
  ...
  guide: { ...en.guide, metaTitle: "Fuengirola-guide | Stay Fuengirola", title: "Fuengirola-guide", intro: "En praktisk guide för att planera din vistelse i Fuengirola. Innehållet fylls på steg för steg.", comingSoon: "Kommer snart", readGuide: "Läs guiden", back: "Tillbaka till guiden", airport: "Från flygplatsen", beaches: "Stränder", supermarkets: "Mataffärer", restaurants: "Restauranger", shopping: "Shopping", transport: "Transport", excursions: "Utflykter", thingsToDo: "Saker att göra i Fuengirola", bioparc: "Bioparc Fuengirola", rain: "Vad man kan göra när det regnar", restaurantsText: "Två lokala klassiker för friterad fisk och grillat kött nära lägenheten.", shoppingText: "Centro Comercial Miramar, Parque Comercial och Fuengirolas centrum.", excursionsText: "Dagsutflykter från Fuengirola: Mijas, Malaga, Ronda, Nerja, Granada och mer.", thingsToDoText: "Bioparc, vattenparker och Marenostrum-konserterna.", bioparcText: "En praktisk familjeguide till Bioparc Fuengirola från lägenheten." }
};
...
const no: Dictionary = {
  ...
  common: { ...en.common, booking: "Sjekk tilgjengelighet på Booking", bookingLong: "Se tilgjengelighet og bestill på Booking.com", whatsapp: "Spør på WhatsApp", whatsappHost: "Spør Nieves på WhatsApp", trust: "Tilgjengelighet, priser og booking sjekkes trygt på Booking.com.", menu: "Åpne meny", size: "Størrelse", guests: "Gjester", beach: "Strand", rating: "Vurdering", language: "Språk" },
  ...
  gallery: { ...en.gallery, title: "Et første blikk på leiligheten og området", intro: "Nåværende referansebilder kan senere erstattes med originale bilder fra overnattingsstedet.", living: "Lys spiseplass ved vinduet", bedroom: "Soveområde", kitchen: "Utstyrt kjøkken", bathroom: "Bad i leiligheten", panoramic: "Panoramabilde av stue og spiseplass", sofa: "Sofa og oppholdsdel", dining: "Spiseplass ved vinduet", garden: "Felles hageområde", pool: "Felles bassengområde", terrace: "Lys spiseplass med naturlig lys", beach: "Fuengirolas strandpromenade", mijas: "Hvit gate i Mijas Pueblo" },
  ...
  guide: { ...en.guide, metaTitle: "Fuengirola-guide | Stay Fuengirola", title: "Fuengirola-guide", intro: "En praktisk guide for å planlegge oppholdet ditt i Fuengirola. Innholdet fylles ut gradvis.", comingSoon: "Kommer snart", readGuide: "Les guiden", back: "Tilbake til guiden", airport: "Fra flyplassen", beaches: "Strender", supermarkets: "Supermarkeder", restaurants: "Restauranter", shopping: "Shopping", transport: "Transport", excursions: "Utflukter", thingsToDo: "Ting å gjøre i Fuengirola", bioparc: "Bioparc Fuengirola", rain: "Hva du kan gjøre når det regner", restaurantsText: "To lokale klassikere for stekt fisk og grillet kjøtt nær leiligheten.", shoppingText: "Centro Comercial Miramar, Parque Comercial og Fuengirola sentrum.", excursionsText: "Dagsturer fra Fuengirola: Mijas, Malaga, Ronda, Nerja, Granada og mer.", thingsToDoText: "Bioparc, vannparker og Marenostrum-konsertene.", bioparcText: "En praktisk familieguide til Bioparc Fuengirola fra leiligheten." }
};
