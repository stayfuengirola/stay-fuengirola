...
const fi: Dictionary = {
  ...
  guide: { ...en.guide, metaTitle: "Fuengirola-opas | Stay Fuengirola", title: "Fuengirola-opas", intro: "Käytännön opas Fuengirolassa oleskelun suunnitteluun. Sisältöä täydennetään vähitellen.", comingSoon: "Tulossa pian", readGuide: "Lue opas", back: "Takaisin oppaaseen", airport: "Saapuminen lentoasemalta", beaches: "Rannat", supermarkets: "Supermarketit", restaurants: "Ravintolat", shopping: "Ostokset", transport: "Liikkuminen", excursions: "Retket", rain: "Mitä tehdä sateella", restaurantsText: "Kaksi paikallista klassikkoa: paistettua kalaa ja grillattua lihaa lähellä asuntoa." }
};
