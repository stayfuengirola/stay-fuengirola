...
const es: Dictionary = {
  ...
  guide: { ...en.guide, metaTitle: "Guía de Fuengirola | Stay Fuengirola", metaDescription: "Guía práctica de Fuengirola para huéspedes: aeropuerto, playas, supermercados, restaurantes, compras, transporte, excursiones y planes de lluvia.", title: "Guía de Fuengirola", intro: "Una guía práctica para preparar tu estancia en Fuengirola, con información local lista para ampliarse poco a poco.", comingSoon: "Próximamente", readGuide: "Ver guía", back: "Volver a la guía", airport: "Cómo llegar desde el aeropuerto", beaches: "Playas", supermarkets: "Supermercados", restaurants: "Restaurantes", shopping: "Compras", transport: "Transporte", excursions: "Excursiones", thingsToDo: "Qué hacer en Fuengirola", rain: "Qué hacer cuando llueve", airportText: "Conexiones desde el Aeropuerto de Málaga hasta Fuengirola.", beachesText: "Playas y paseos junto al mar cerca del apartamento.", supermarketsText: "Supermercados cercanos y compras prácticas.", restaurantsText: "Dos clásicos locales de pescaíto frito y carne a la brasa cerca del apartamento.", shoppingText: "Centro Comercial Miramar, Parque Comercial y el centro de Fuengirola.", transportText: "Tren, taxi y formas de moverse por la Costa del Sol.", excursionsText: "Excursiones fáciles desde Fuengirola.", thingsToDoText: "Bioparc, parques acuáticos y los conciertos de Marenostrum.", rainText: "Ideas para días tranquilos o con lluvia." }
};
...
const fi: Dictionary = {
  ...
  guide: { ...en.guide, metaTitle: "Fuengirola-opas | Stay Fuengirola", title: "Fuengirola-opas", intro: "Käytännön opas Fuengirolassa oleskelun suunnitteluun. Sisältöä täydennetään vähitellen.", comingSoon: "Tulossa pian", readGuide: "Lue opas", back: "Takaisin oppaaseen", airport: "Saapuminen lentoasemalta", beaches: "Rannat", supermarkets: "Supermarketit", restaurants: "Ravintolat", shopping: "Ostokset", transport: "Liikkuminen", excursions: "Retket", thingsToDo: "Mitä tehdä Fuengirolassa", rain: "Mitä tehdä sateella", restaurantsText: "Kaksi paikallista klassikkoa: paistettua kalaa ja grillattua lihaa lähellä asuntoa.", shoppingText: "Centro Comercial Miramar, Parque Comercial ja Fuengirolan keskusta.", thingsToDoText: "Bioparc, vesipuistot ja Marenostrumin konsertit." }
};
